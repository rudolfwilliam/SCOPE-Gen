...
from scope_gen.molecules.data.conversions import tuple_to_mol, smiles_to_mol

import torch

def remove_atom(mol):
    from random import choice
    from scope_gen.molecules.data.conversions import mol_to_tuple, clean_and_convert_samples
