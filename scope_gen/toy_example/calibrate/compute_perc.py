from scope_gen.calibrate import compute_perc
from scope_gen.predictors import compute_phat
from scope_gen.distances import SquaredL2Distance
from scope_gen.toy_example.paths import CKPT_DIR, DATA_DIR
from scope_gen.nc_scores import CGScore
import torch
...
def main(epsilon, alpha):
    ...
    # save percentile
    torch.save(data_perc, DATA_DIR + "/scope_gen_data/percentile.pt")
