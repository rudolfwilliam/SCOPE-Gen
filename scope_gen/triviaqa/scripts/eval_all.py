...
from scope_gen.triviaqa.scripts.eval_clm import eval as eval_clm
from scope_gen.triviaqa.scripts.eval import eval as eval_scope_gen
from scope_gen.triviaqa.paths import CONFIG_DIR
