"""Much of this is taken from https://github.com/cvignac/DiGress/blob/guidance/src/guidance/qm9_regressor_discrete.py"""
...
class MolRegressorDiscrete(pl.LightningModule):
    def __init__(self, cfg, dataset_infos, train_metrics, sampling_metrics, extra_features, domain_features):
        super().__init__()
