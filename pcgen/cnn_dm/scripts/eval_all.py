...
from pcgen.cnn_dm.scripts.eval_clm import eval as eval_clm
from pcgen.cnn_dm.scripts.eval import eval as eval_scacgen
from pcgen.cnn_dm.paths import CONFIG_DIR
